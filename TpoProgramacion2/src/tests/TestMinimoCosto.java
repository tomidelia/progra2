...
public class TestMinimoCosto {
    public static void main(String[] args) {
        ...
        grafo.agregarVuelo(new Vuelo(a1, a3, 700, 5));

        System.out.println("Camino mínimo por costo de BUE a LIM:");
        for (Aeropuerto a : grafo.dijkstra("BUE", "LIM", TipoPeso.COSTO)) {
